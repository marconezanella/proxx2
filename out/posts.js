...
var Router = function Router(server, url_api) {
  ...
  server.get("/formulario/v1/:id_etapa", function (req, res) {
    ...
    // console.log(req.query)
    // tratarResposta(req, res, id_lead, caminho);
    tratarResposta(req, res, id_lead, caminho, id_etapa);
  });
  server.get("/pay/fatura/:id_pagamento", function (req, res) {
    ...
    tratarResposta(req, res, id_lead, caminho, id_pagamento);
  });
  server.get("/key/:id_link/:caminho", function (req, res) {
    ...
    tratarResposta(req, res, id_lead, caminho, req.params.id_link);
  });
